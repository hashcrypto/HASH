...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"hash", "masternodelist", &masternodelist, true, true, false},
        {"hash", "mnbudget", &mnbudget, true, true, false},
        {"hash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"hash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hash", "mnsync", &mnsync, true, true, false},
        {"hash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"hash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hashd, or the -server option to hash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39977/\n";
}
