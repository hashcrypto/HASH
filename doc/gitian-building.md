...
git clone https://github.com/hash-crypto/hash.git
cd hash
...
```bash
    ...
    From https://github.com/hash-crypto/hash
...
For example:
```bash
URL=https://github.com/crowning-/hash.git
...
[hash/gitian.sigs](https://github.com/hash-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
