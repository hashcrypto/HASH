Hash Core version 2.2.1 is now available from:

  <https://github.com/hash-project/hash/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/hash-project/hash/issues>
...
of Bitcoin that Hash was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/hash-project-translations/).
